...
test_set = test_datagen.flow_from_directory(
    os.path.join(deepeye_path, "Images/cnnImages/MultiClassifier/Testing"), target_size=(256, 256), batch_size=32
)
...
with open(os.path.join(deepeye_path, "Logs/cnnLogs/multi_output_logs.txt"), "w") as log_file:
