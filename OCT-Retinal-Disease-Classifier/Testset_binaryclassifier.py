...
model_path = os.path.join(deepeye_path, 'Models/SaiModels/best_tl_binary_model.h5')
tl_model = load_model(model_path)

# Define the path to the test images directory
test_images_dir = os.path.join(deepeye_path, 'Images/SaiImages/BinaryClassifier/Testing')
...
for label in class_labels:
    label_dir = os.path.join(os.path.join(deepeye_path, 'Images/SaiImages/BinaryClassifier/Testing'), label)
