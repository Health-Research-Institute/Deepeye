...
model_path = AbsolutePath + 'Models/SaiModels/best_tl_binary_model.h5'
tl_model = load_model(model_path)

# Define the path to the test images directory
test_images_dir = AbsolutePath + 'Images/SaiImages/BinaryClassifier/Testing'
...
for label in class_labels:
    label_dir = os.path.join(AbsolutePath + 'Images/SaiImages/BinaryClassifier/Testing', label)
