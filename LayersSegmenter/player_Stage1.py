...
for fN in range(0,len(folderN)): 
    for tClass in range(0,len(classNames)):
        imagesPathRead = '../Images/CT_RETINA/' + classNames[tClass] + '/' + folderN[fN]
        imagesPathWrite ='../Images/CT_RETINA/' + classNames[tClass] + '/' + folderN[fN] + '9L'
        ...
        print('Class',  classNames[tClass], ' part' , fN+1, ' is done')
